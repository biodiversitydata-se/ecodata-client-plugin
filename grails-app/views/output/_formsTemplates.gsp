...
<svg viewBox="0 0 304 40" class="condition-trajectory" aria-labeledby="title" role="diagram">
    ...
    <svg data-bind="attr:{x:boxPosition, title:title}" y="0"><title data-bind="text:title"></title>
        <g transform="scale(0.3)">
            <rect class="trajectory" x="4" y="5" width="95" height="93"></rect>
            <svg class="trajectory-icon"  x="10" y="10" width="80" height="80" data-bind="template:trajectoryTemplate">
